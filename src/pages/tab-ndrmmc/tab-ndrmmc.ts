...
/**
 * Generated class for the TabNdrmmcPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-tab-ndrmmc',
  templateUrl: 'tab-ndrmmc.html',
})
export class TabNdrmmcPage {

  @ViewChild('virtualScroll', { read: VirtualScroll }) virtualScroll: VirtualScroll;

  notif: any;
  ref = firebase.database().ref('posts/reports/ndrmmc');
  identifier: any;
  length: any;
  posts: any = [];
